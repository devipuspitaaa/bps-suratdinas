         ...
         <div class="row">
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" name="kode_1" class="form-control" value="{{ $historytemplate->kode_1 }}" placeholder="..." required="">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" name="kode_2" class="form-control" value="{{ $historytemplate->kode_2 }}" placeholder="..." required="">
                    <small>Masukkan form</small>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" name="kode_3" class="form-control" value="{{ $historytemplate->kode_3 }}" placeholder="..." required="">
                    <small>Masukkan form</small>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" name="kode_4" class="form-control" value="{{ $historytemplate->kode_4 }}" placeholder="...">
                    <small>Masukkan form</small>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" name="kode_5" class="form-control" value="{{ $historytemplate->kode_5 }}" placeholder="...">
                    <small>Masukkan form</small>
                </div>
            </div>
        </div>
...
<script>
            ...
            CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
                ...
                placeholder: 'Silahkan isi struktur surat pada form ini',
